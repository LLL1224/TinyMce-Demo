 ...
 */
 (function (domGlobals) {
    ...
    function trimHtml(html) {
      ...
      const style = html.replace(/^[\s\S]*<style[^>]*>\s*<!--\s*|\s*-->\s*<\/style[^>]*>[\s\S]*$/g, '');
      const newHtml = filter$1(html, [
      ...
      //   const classNames = newHtml.match(/class=\".*?\"/g)
      //   console.log('html!!!!!!!!', style, classNames);
      // html = filter$1(html, [
      //   /^[\s\S]*<body[^>]*>\s*|\s*<\/body[^>]*>[\s\S]*$/ig,
      //   /<!--StartFragment-->|<!--EndFragment-->/g,
      //   [
